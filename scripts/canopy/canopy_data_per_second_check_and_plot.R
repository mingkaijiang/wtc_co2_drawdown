canopy_data_per_second_check_and_plot <- function(myDF){
    ...
    p1 <- ggplot(myDF, aes(WTC_CO2))+
        geom_point(aes(y=Revised_CO2_flux, shape=factor(Canopy), color=factor(Chamber)), size=2.0)+
    ...
    ### Chamber 1 example
    p3 <- ggplot(myDF[myDF$Chamber==1,], aes(x=time_elapsed, y=Revised_CO2_flux, color=factor(Canopy)))+
        geom_point(size=2.0)+
        geom_smooth(se=TRUE, method="gam", formula = y~s(x))+
    ...
    ### Chamber 2 example
    p4 <- ggplot(myDF[myDF$Chamber==2,], aes(x=time_elapsed, y=Revised_CO2_flux, color=factor(Canopy)))+
        geom_point(size=2.0)+
        geom_smooth(se=TRUE, method="gam", formula = y~s(x))+
        labs(x="Time", y=expression(paste(CO[2], " flux (umol ", m^-2, " ", s^-1, ")")))+
        theme_linedraw() +
    ...
    ### Chamber 3 example
    p5 <- ggplot(myDF[myDF$Chamber==3,], aes(x=time_elapsed, y=Revised_CO2_flux, color=factor(Canopy)))+
        geom_point(size=2.0)+
        geom_smooth(se=TRUE, method="gam", formula = y~s(x))+
        labs(x="Time", y=expression(paste(CO[2], " flux (umol ", m^-2, " ", s^-1, ")")))+
        theme_linedraw() +
    ...
    ### Chamber 4 example
    p6 <- ggplot(myDF[myDF$Chamber==4,], aes(x=time_elapsed, y=Revised_CO2_flux, color=factor(Canopy)))+
        geom_point(size=2.0)+
        geom_smooth(se=TRUE, method="gam", formula = y~s(x))+
        labs(x="Time", y=expression(paste(CO[2], " flux (umol ", m^-2, " ", s^-1, ")")))+
        theme_linedraw() +
    ...
    ### Chamber 7 example
    p7 <- ggplot(myDF[myDF$Chamber==7,], aes(x=time_elapsed, y=Revised_CO2_flux, color=factor(Canopy)))+
        geom_point(size=2.0)+
        geom_smooth(se=TRUE, method="gam", formula = y~s(x))+
        labs(x="Time", y=expression(paste(CO[2], " flux (umol ", m^-2, " ", s^-1, ")")))+
        theme_linedraw() +
    ...
    ### Chamber 8 example
    p8 <- ggplot(myDF[myDF$Chamber==8,], aes(x=time_elapsed, y=Revised_CO2_flux, color=factor(Canopy)))+
        geom_point(size=2.0)+
        geom_smooth(se=TRUE, method="gam", formula = y~s(x))+
        labs(x="Time", y=expression(paste(CO[2], " flux (umol ", m^-2, " ", s^-1, ")")))+
        theme_linedraw() +
    ...
    ### Chamber 11 example
    p9 <- ggplot(myDF[myDF$Chamber==11,], aes(x=time_elapsed, y=Revised_CO2_flux, color=factor(Canopy)))+
        geom_point(size=2.0)+
        geom_smooth(se=TRUE, method="gam", formula = y~s(x))+
        labs(x="Time", y=expression(paste(CO[2], " flux (umol ", m^-2, " ", s^-1, ")")))+
        theme_linedraw() +
    ...
    ### Chamber 12 example
    p10 <- ggplot(myDF[myDF$Chamber==12,], aes(x=time_elapsed, y=Revised_CO2_flux, color=factor(Canopy)))+
        geom_point(size=2.0)+
        geom_smooth(se=TRUE, method="gam", formula = y~s(x))+
        labs(x="Time", y=expression(paste(CO[2], " flux (umol ", m^-2, " ", s^-1, ")")))+
        theme_linedraw() +
