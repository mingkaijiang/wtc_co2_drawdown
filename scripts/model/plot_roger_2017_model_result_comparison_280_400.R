plot_roger_2017_model_result_comparison_280_400 <- function() {
    ...
    subDF <- subset(plotDF, Ca>=200&Ca<=450)
    
    ### Fit linear function to the 350 - 650 range, 
    ### then predict A400, A400 responses
    ...
    colnames(outDF) <- c("Model", "slope_leaf_vc45", "intercept_leaf_vc45", 
                         "r_sq_leaf_vc45", "A400_leaf_vc45", "A280_leaf_vc45",
                         "slope_leaf_vc60", "intercept_leaf_vc60", 
                         "r_sq_leaf_vc60", "A400_leaf_vc60", "A280_leaf_vc60",
                         "slope_can_vc45", "intercept_can_vc45", 
                         "r_sq_can_vc45", "A400_can_vc45", "A280_can_vc45",
                         "slope_can_vc60", "intercept_can_vc60",
                         "r_sq_can_vc60", "A400_can_vc60", "A280_can_vc60")
    ...
    outDF$A280_leaf_vc45 <- outDF$slope_leaf_vc45 * 280 + outDF$intercept_leaf_vc45
    outDF$A280_leaf_vc60 <- outDF$slope_leaf_vc60 * 280 + outDF$intercept_leaf_vc60
    outDF$A280_can_vc45 <- outDF$slope_can_vc45 * 280 + outDF$intercept_can_vc45
    outDF$A280_can_vc60 <- outDF$slope_can_vc60 * 280 + outDF$intercept_can_vc60
    
    ### (A400-A280)/A280 to look at sensitivity
    outDF$sens_leaf_vc45 <- (outDF$A400_leaf_vc45 - outDF$A280_leaf_vc45)/outDF$A280_leaf_vc45
    outDF$sens_leaf_vc60 <- (outDF$A400_leaf_vc60 - outDF$A280_leaf_vc60)/outDF$A280_leaf_vc60
    outDF$sens_can_vc45 <- (outDF$A400_can_vc45 - outDF$A280_can_vc45)/outDF$A280_can_vc45
    outDF$sens_can_vc60 <- (outDF$A400_can_vc60 - outDF$A280_can_vc60)/outDF$A280_can_vc60
